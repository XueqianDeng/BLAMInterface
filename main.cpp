/* 
* 2021/12/28 Hokin Deng
* Based on the previous version developed for Kinereach in BLAM lab at Johns Hopkins.
* This is a version that tries to restructure the interface in order for the software
* to run under different enviroments. including Windows etc., and perhaps extend to 
* iOS envir too. This is an experimental version. 
*/
